...
namespace TeiaAPI.Repositorios.Interfaces
{
    ...
    {
        public Task<List<VistoriaModel>> GetAllVistorias(int? id = null, StatusVistoriaEnum? status = null, TypeEnum? tipoServico = null, DateTime? dataInicio = null, DateTime? dataFim = null, tipoImovelEnum? tipoImovel = null);
