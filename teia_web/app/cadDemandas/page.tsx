...
export default function Demandas() {
  ...
  //   try {
  //     const res = await postNewVistoria(dataForm);
  //     if (res) {
  ...
  //     if (data) {
  //       setVistoriadores(data.map((vistoriador) => ({
      ...
      >
        <div className="flex gap-8 w-full justify-start items-center">
          <div className="flex flex-col gap-3 justify-start items-start">
            ...
            <Input id="numOs" type="text" {...register("numOs")} />
          </div>
          <div className="flex flex-col  gap-3 justify-start items-start">
            <Label htmlFor="type">
              Tipo de Serviço{" "}
            ...
            <Select id="tipo" style={{ width: "260px" }} {...register("tipo")}>
        ...
        <div className="flex gap-8 w-full justify-start items-center">
          {errorMenssage && (
            <span className="text-red-500">{errorMenssage}</span>
          )}
